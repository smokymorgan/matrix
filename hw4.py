...
linear_dep_R_2 = [2*math.pi, 1, math.pi/math.sqrt(2)]
...
indep_vec_1 = Vec({0, 1}, {})
indep_vec_2 = Vec({0, 1}, {0:1})
indep_vec_3 = Vec({0, 1}, {1:1})
indep_vec_4 = Vec({0, 1}, {0:1, 1:1})
...
def vec2rep(veclist, v):
    ...
    Example:
        ...
        True
    '''
    # Need to use Solve since we can't reverse Matrices --- so to speak...
    CprimeAish= coldict2mat(veclist)
    return solve(CprimeAish, v)
